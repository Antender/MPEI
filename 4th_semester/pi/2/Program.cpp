...
//---------------------------------------------------------------------------
void __fastcall TMainForm::ChangeTranslation(TObject *Sender)
{
  (*translations)[(*new std::string(MainForm->Word->Text.c_str()))] = (*new std::string(MainForm->Translation->Text.c_str()));
}
//---------------------------------------------------------------------------
